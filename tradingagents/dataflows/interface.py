...
VENDOR_METHODS = {
    ...
    # technical_indicators — all use stockstats on top of load_ohlcv (which dispatches
    # to AKShare or yfinance based on STOCK_SOURCE), so one implementation serves all.
    "get_indicators": {
